...
namespace gHRM.Service
{
    ...
    public class Inv_RequsitionMasterService : IInv_RequsitionMasterService
    {
        ...
        public Inv_RequsitionMaster Get(Expression<Func<Inv_RequsitionMaster, bool>> where)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<Inv_RequsitionMaster>> GetAllAsync()
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<Inv_RequsitionMaster>> GetManyAsync(Expression<Func<Inv_RequsitionMaster, bool>> where)
        {
            throw new NotImplementedException();
        }

        public Task<Inv_RequsitionMaster> GetAsync(Expression<Func<Inv_RequsitionMaster, bool>> where)
        {
            throw new NotImplementedException();
        }
    }
