...
namespace gHRM.Service
{
    ...
    public class InvTrxDetailService : IInvTrxDetailService
    {
        ...
        public Inv_TrxDetail Get(Expression<Func<Inv_TrxDetail, bool>> where)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<Inv_TrxDetail>> GetAllAsync()
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<Inv_TrxDetail>> GetManyAsync(Expression<Func<Inv_TrxDetail, bool>> where)
        {
            throw new NotImplementedException();
        }

        public Task<Inv_TrxDetail> GetAsync(Expression<Func<Inv_TrxDetail, bool>> where)
        {
            throw new NotImplementedException();
        }
    }
