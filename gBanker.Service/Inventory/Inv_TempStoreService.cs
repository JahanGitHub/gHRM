...
namespace gHRM.Service
{
    ...
    public class Inv_TempStoreService : IInv_TempStoreService
    {
        ...
        public Inv_TempStore Get(Expression<Func<Inv_TempStore, bool>> where)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<Inv_TempStore>> GetAllAsync()
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<Inv_TempStore>> GetManyAsync(Expression<Func<Inv_TempStore, bool>> where)
        {
            throw new NotImplementedException();
        }

        public Task<Inv_TempStore> GetAsync(Expression<Func<Inv_TempStore, bool>> where)
        {
            throw new NotImplementedException();
        }
    }
