...
namespace gHRM.Service
{
    ...
    public class Inv_VendorService : IInv_VendorService
    {
        ...
        public Inv_Vendor Get(Expression<Func<Inv_Vendor, bool>> where)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<Inv_Vendor>> GetAllAsync()
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<Inv_Vendor>> GetManyAsync(Expression<Func<Inv_Vendor, bool>> where)
        {
            throw new NotImplementedException();
        }

        public Task<Inv_Vendor> GetAsync(Expression<Func<Inv_Vendor, bool>> where)
        {
            throw new NotImplementedException();
        }
    }
