...
namespace gHRM.Service
{
    ...
    public class InvWarehouseService : IInvWarehouseService
    {
        ...
        public InvWarehouse Get(Expression<Func<InvWarehouse, bool>> where)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<InvWarehouse>> GetAllAsync()
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<InvWarehouse>> GetManyAsync(Expression<Func<InvWarehouse, bool>> where)
        {
            throw new NotImplementedException();
        }

        public Task<InvWarehouse> GetAsync(Expression<Func<InvWarehouse, bool>> where)
        {
            throw new NotImplementedException();
        }
    }
