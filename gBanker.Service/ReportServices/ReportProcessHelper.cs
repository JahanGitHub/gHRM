...
namespace gHRM.Service.ReportServices
{
    public static class SSRSReportProcessHelper
    {
        private static byte[] RenderReport
            (string format, string ServiceURL, string ReportName, ParameterValue[] parameters, string UserId, string Password, string dataSource, string initialCatalog, ref string Status)
        {
            ...
            if (execInfo.DataSourcePrompts.Length > 0)
                ...
                dataSourceCredentials.DataSourceName = "gHRMPlus";
            // dataSourceCredentials.DataSourceName = "gHRMDbContext";
        ...
        public static byte[] RenderReport(string format, string ReportName, ParameterValue[] parameters, ref string Status, string connectionStringName = "gHRMReportDbContext")
        {
            ...
            return RenderReport(format, serverUrl, ReportName, paramList.ToArray(), user, pwd, datasource, dbname, ref Status);
        }
