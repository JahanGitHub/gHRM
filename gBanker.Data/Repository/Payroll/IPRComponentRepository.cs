...
{
    public interface IPRComponentRepository : IRepository<PRComponent>
    {
    ...
    public class PRComponentRepository : RepositoryBaseCodeFirst<PRComponent>, IPRComponentRepository
    {
        public PRComponentRepository(IDatabaseFactoryCodeFirst databaseFactory)
