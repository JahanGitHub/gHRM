...
{
    public class FinalSattlementViewModel : BaseModel
    {
        ...
        public string  StatusFromDateMsg { get; set; }

        [Display(Name = "Status To Date ")]
        [DisplayFormat(DataFormatString = "{0:dd-MMM-yyyy}", ApplyFormatInEditMode = true)]
        public DateTime ? StatusToDate { get; set; }
        public string StatusToDateMsg { get; set; }
        ...
        [Display(Name = "Job Permanent Date")]
        [DisplayFormat(DataFormatString = "{0:dd-MMM-yyyy}", ApplyFormatInEditMode = true)]
        ...
        [Display(Name = "Post Office (পোস্ট অফিস)")]
        ...
        [Display(Name = "E-TIN No. (ই-টিন নাম্বার)")]
      ...
      //  public string Image64 { get { return EmployeeImage != null ? Convert.ToBase64String(EmployeeImage) : null; } }
        ...
        //employee roaster schedule
        public DateTime RoasterEffectiveStartDate { get; set; }
        public DateTime RoasterEffectiveEndDate { get; set; }        
    }


    public class PurposeNameForPayment
    {
        public int Id { get; set; }
