...
var staffWelfareFundSettingManager = {
    ...
    loadStaffWelfareFundSettingListing: function () {
        ...
        var dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: '/FundSetup/GetStaffWelfareFundSettingListing',
                    dataType: 'json'
                }
            }
        });
                ...
                },
                {
                 ...
                 },
                 {
                     ...
                     template: function (data) {
                         var btn = "";                        
                         btn += '<div class="text-center"><a href="#" OnClick="staffWelfareFundSettingManager.informationDelete(' + data.Id + ');"><i class="fa fa-close"></i></a></div>';
                         return btn;
                     }
                 },
            ]
