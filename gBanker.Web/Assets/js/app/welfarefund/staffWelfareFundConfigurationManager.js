...
var staffWelfareFundConfigurationManager = {
        ...
        $.alert.open('confirm', 'Are you sure you want to delete this record?', function (button) {
            if (button == 'yes') {
                $.ajax({
                    ...
                    url: '/StaffWelfareFundConfiguration/Delete',
                    data: { id: id },
                    dataType: 'json',
                    async: true,
                    success: function (data) {
                        if (data.type == 'success') {
                            //get listing
                            staffWelfareFundConfigurationManager.loadstaffWelfareFundConfigurationListing();
                            //success alert
    ...
    populateEditableInfo: function (id) {
        ...
        $.ajax({
            url: '/StaffWelfareFundConfiguration/GetStaffWelfareFundConfiguration/' + id,
            method: 'GET',
            cache: false,
            dataType: 'json'
    ...
    loadStaffWelfareFundConfigListing: function () {
        ...
        var dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: '/StaffWelfareFundConfiguration/GetStaffWelfareFundConfigurationListing',
                    dataType: 'json'
                }
            }
        });
        $("#grid").kendoGrid({
            ...
            columns: [
                {
                    field: "StaffWelfareFundConfigurationId",
                    hidden: true,
                    filterable: false
                },
                {
                ...
                //},
                {
                    ...
                    template: function (data) {
                        var btn = "";
                        btn += '<div class="text-center" style="float:left;"><a href="#" OnClick="staffWelfareFundSettingManager.populateEditableInfo(' + data.StaffWelfareFundSettingId + ');"><i class="fa fa-pencil-square-o"></i></a></div>';
                        btn += '<div class="text-center"><a href="#" OnClick="staffWelfareFundSettingManager.informationDelete(' + data.StaffWelfareFundSettingId + ');"><i class="fa fa-trash-o"></i></a></div>';
                        return btn;
                    }
                },
            ]
...
function GetPRComponentListFund() {
    ...
    $.ajax({
        type: 'GET',
        contentType: "application/json; charset=utf-8",
        url: '/StaffWelfareFundConfiguration/GetPRpurposeListFund',
        dataType: 'json',
        async: true,
        success: function (data) {
            ddlComponent.html('');
