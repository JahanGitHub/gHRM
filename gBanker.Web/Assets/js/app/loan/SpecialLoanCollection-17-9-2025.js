...
$(document).ready(function () {
    ...
    $("#EmployeeCode").blur(function () {
        ...
        if (obj.EmployeeId) {
            ...
            var ddlObj = GenerateAjaxRequist('/Loan/GetLoanNoByEmployeeForDropdown', { employeeId: obj.EmployeeId, isClose: false }, "GET");
    ...
    $("#btnView").click(function (e) {
        ...
        if (!$("#LoanID").val()) $.alert.open("Warning", "Loan No. is required.");
            ...
            var json_Obj = GenerateAjaxRequist('/Loan/GetLoanDetailsById', { loanid: $("#LoanID").val(), uptodate: $("#InterestUptoDate").val() }, "GET");
    ...
    $("#btnSave").click(function (e) {
        ...
        if (message) $.alert.open("Warning", message);
            ...
            var json_Obj = GenerateAjaxRequist('/Loan/PostSpecialCollection', JSON.stringify({ model: dataObject }), "POST");
            if (json_Obj) {
