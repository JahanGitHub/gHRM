...
function PrintSalaryBeforeApprovalReportPDF2(year, month, officeTypeId, salaryDate, officeID, w_o_HO, reportId ) {
    url = '/PRSalaryReport/PrintSalaryBeforeApprovalReportPDF_SalaryAdvice?Year=' + year + '&Month=' + month + '&officeTypeId=' + officeTypeId + '&salaryDate=' + salaryDate + '&officeID=' + officeID + '&w_o_HO=' + w_o_HO + '&reportId=' + reportId;
    window.open(url, 'mywindow', 'fullscreen=yes, scrollbars=auto');
}
