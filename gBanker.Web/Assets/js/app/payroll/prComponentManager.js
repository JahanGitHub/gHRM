...
function getPRComponentListing() {
    ...
    if (!employeeTypeId || !employeeStatusId) {
        //$.alert.open("Error", "Please Employee type and status");
        return;
    }
    ...
    var dataSource = new kendo.data.DataSource({
        ...
        transport: {
            read: {
                url: '/PRComponent/GetComponentList',
                dataType: 'json',
                data: { employeeTypeId: employeeTypeId, employeeStatusId: employeeStatusId }
            }
        }
    });
