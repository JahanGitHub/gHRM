...
function PrintSalaryBeforeApprovalReportPDF(year, month, officeTypeId, salaryDate, officeID, w_o_HO) {
    url = '/PRSalaryReport/PrintSalaryBeforeApprovalReportPDF?Year=' + year + '&Month=' + month + '&officeTypeId=' + officeTypeId + '&salaryDate=' + salaryDate + '&officeID=' + officeID + '&w_o_HO=' + w_o_HO;
    window.open(url, 'mywindow', 'fullscreen=yes, scrollbars=auto');
}

function PrintSalaryBeforeApprovalReportExel(year, month, officeTypeId, salaryDate, officeID, w_o_HO) {
    url = '/PRSalaryReport/PrintSalaryBeforeApprovalReportExel99?Year=' + year + '&Month=' + month + '&officeTypeId=' + officeTypeId + '&salaryDate=' + salaryDate + '&officeID=' + officeID + '&w_o_HO=' + w_o_HO;
    window.open(url, 'mywindow', 'fullscreen=yes, scrollbars=auto');
}
...
function PrintApprovedSalaryReportExel2(year, month, officeTypeId, salaryDate, officeID, w_o_HO) {
    url = '/PRSalaryReport/PrintApprovedSalaryReportExel2?Year=' + year + '&Month=' + month + '&officeTypeId=' + officeTypeId + '&salaryDate=' + salaryDate + '&officeID=' + officeID +'&w_o_HO='+ w_o_HO;
    window.open(url, 'mywindow', 'fullscreen=yes, scrollbars=auto');
}
...
function ProcessMonthlySalary(empType, month) {
    ...
    $.ajax({
        type: 'GET',
        contentType: "application/json; charset=utf-8",
        url: '/PRProcess/MonthlySalaryProcess_EmpCode',
        data: {
            empType: empType,
            month: month,
    ...
    $("#btnPrint").click(function () {
        ...
        /*else if (type == "4") {
            ...
            if (year != "" && year != '0' && month != "" && month != '0') {
                ...
                PrintApprovedSalaryReportExel2(year, month, officeTypeId, salaryDate, officeID, w_o_HO);
            } else {
                $.alert.open("Error", "Please Insert Required Fields");
            }
        }
