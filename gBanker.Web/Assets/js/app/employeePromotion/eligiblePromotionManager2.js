            ...
            },
            {
                ...
                template: function (dataItem) {
                    var actions = ` <div class="text-center"> 
                                        <a title="Promote this Employee" target="_blank" href="/PRSalaryConfiguration/Index3?employeeCode=${dataItem.EmployeeCode}&promotionId=${dataItem.PromotionId} "><i class="fa fa-thumbs-up"></i></a>
