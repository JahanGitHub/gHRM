...
namespace gHRM.Web.Controllers.Inventory
{
    public class InventoryReportController : BaseController
    {
            ...
            , DateTime? to, string empCode, int? OfficeID, string OfficeCode)
        {
            try
            {
                ...
                if (reportTypeId > 0)
                {
                    var paramValues = new List<gHRM.Service.ReportExecutionService.ParameterValue>();
                    ...
                    if (reportTypeId == 1)
                    {
                        ...
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "OrgName", Value = (SessionHelper.OrganizationName).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "WarehouseID", Value = (wList.First().WarehouseID).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "FromDate", Value = (from ?? DateTime.Now).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "toDate", Value = (to ?? DateTime.Now).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "ItemID", Value = (itemId).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "CategoryId", Value = (categoryId).ToString() });
                    ...
                    else if (reportTypeId == 2 | reportTypeId == 3)
                    {
                        ...
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "ToDate", Value = (to ?? DateTime.Now).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "ItemID", Value = (itemId).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "storeID", Value = (wList.First().WarehouseID).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "CategoryId", Value = (categoryId).ToString() });
                    ...
                    else if (reportTypeId == 4)
                    {
                        ...
                        if (!string.IsNullOrEmpty(empCode))
                        {
                            ...
                            if (emp != null)
                                empID = Convert.ToInt32(emp.EmployeeId);
                        }
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "OrgName", Value = (SessionHelper.OrganizationName).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "empID", Value = empID.ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "FromDate", Value = (from ?? DateTime.Now).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "ToDate", Value = (to ?? DateTime.Now).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "ItemID", Value = (itemId).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "storeID", Value = (wList.First().WarehouseID).ToString() });
                    ...
                    else if (reportTypeId == 5 || reportTypeId == 10)
                    {
                        ...
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "storeID", Value = (wList.First().WarehouseID).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "CategoryId", Value = (categoryId).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "ReportTypeId", Value = (reportTypeId).ToString() });
                    ...
                    else if (reportTypeId == 6 | reportTypeId == 7)
                    {
                        ...
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "OrgName", Value = (SessionHelper.OrganizationName).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "officeID", Value = (OfficeID ?? 0).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "ReportType", Value = reportType });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "CategoryID", Value = (categoryId).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "ItemID", Value = (itemId).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "FromDate", Value = (from ?? DateTime.Now).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "ToDate", Value = (to ?? DateTime.Now).ToString() });
                    ...
                    else if (reportTypeId == 8)
                    {
                        ...
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "FromDate", Value = (from ?? DateTime.Now).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "ToDate", Value = (to ?? DateTime.Now).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "POfficeCode", Value = off.OfficeCode });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "POfficeName", Value = off.OfficeName });
                    ...
                    else if (reportTypeId == 9/*Store Summary Report*/)
                    {
                        ...
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "OrgName", Value = (SessionHelper.OrganizationName).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "warehouseID", Value = (storeID).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "FromDate", Value = (from ?? DateTime.Now).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "ToDate", Value = (to ?? DateTime.Now).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "POfficeCode", Value = off.OfficeCode });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "POfficeName", Value = off.OfficeName });
                    ...
                    else if (reportTypeId == 11)
                    {
                        ...
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "OrgName", Value = (SessionHelper.OrganizationName).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "RequestWareID", Value = (storeID).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "from", Value = (from ?? DateTime.Now).ToString("dd-MMM-yyyy") });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "to", Value = (to ?? DateTime.Now).ToString("dd-MMM-yyyy") });
                        // paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "thisOffice", Value = !string.IsNullOrEmpty(OfficeCode)?1:});
                    ...
                    else if (reportTypeId == 20 || reportTypeId == 21 || reportTypeId == 22 || reportTypeId == 23)
                    {
                        ...
                        if (reportTypeId == 23)
                        {
                            paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "officeCode", Value = OfficeCode });
                            paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "OfficeType", Value = (SessionHelper.LoggedInOfficeDetail.OfficeLevel == 2 ? "ZO" : SessionHelper.LoggedInOfficeDetail.OfficeLevel==1 ? "Ho" : "") });
                        }
                        else
                            paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "OfficeType", Value =(SessionHelper.LoggedInOfficeDetail.OfficeLevel == 1? "Ho":"")});
                            
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "OrgName", Value = (SessionHelper.OrganizationName).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "OfficeID", Value = (OfficeID ?? storeID).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "ItemID", Value = (itemId).ToString() });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "FromDate", Value = (from ?? DateTime.Now).ToString("dd-MMM-yyyy") });
                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "ToDate", Value = (to ?? DateTime.Now).ToString("dd-MMM-yyyy") });

                        paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "reportType", Value = (reportTypeId == 20 ? "" : reportTypeId == 21 ? "Item" : reportTypeId == 22 ? "OffItem" : reportTypeId == 23 ? "OffDisposeItem" : "") });
                    ...
                    PrintSSRSReport(report, paramValues.ToArray());
        ...
        public ActionResult RequsitionReport(string status, int rmID)
        {
            try
            {
                ...
                else
                {
                    ...
                    wList = iInvWarehouseService.GetOfficeIDWise(LoginUserOfficeID ?? 0);
                    paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "OrgName", Value = (SessionHelper.OrganizationName).ToString() });
                    paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "reqMasterID", Value = (rmID).ToString() });
                    paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "apStatus", Value = status });
                    PrintSSRSReport("/gBanker_Reports/rpt_inv_Requsition", paramValues.ToArray());
                    return Content(string.Empty);
        ...
        public ActionResult VoucherReport(long masterID)
        {
            try
            {
                ...
                {
                    var paramValues = new List<gHRM.Service.ReportExecutionService.ParameterValue>();
                    paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "masterID", Value = masterID.ToString() });
                    PrintSSRSReport("/gBanker_Reports/rpt_inv_Voucher", paramValues.ToArray());
                    return Content(string.Empty);
                }
            }
            catch (Exception ex)
        ...
        public ActionResult ItemXStoreDetailsReport(long masterID, string type)
        {
            try
            {
                ...
                else
                {
                    ...
                    var paramValues = new List<gHRM.Service.ReportExecutionService.ParameterValue>();
                    paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "TrxMasterID", Value = masterID.ToString() });
                    PrintSSRSReport("/gBanker_Reports/" + report + "", paramValues.ToArray());
                    return Content(string.Empty);
                }
            }
            catch (Exception ex)
        ...
        public ActionResult StoreReportForArea(int reuqisitionID, string status)
        {
            try
            {
                ...
                {
                    var paramValues = new List<gHRM.Service.ReportExecutionService.ParameterValue>();
                    paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "status", Value = status });
                    paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "OfficeID", Value = LoginUserOfficeID.Value.ToString() });
                    paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "masterID", Value = reuqisitionID.ToString() });
                    PrintSSRSReport("/gBanker_Reports/rpt_inv_StoreReportBuro", paramValues.ToArray());
                    return Content(string.Empty);
        ...
        public ActionResult DayWiseVoucher(int reportTypeId, DateTime from, DateTime to)
        {
            try
            {
                ...
                {
                    var paramValues = new List<gHRM.Service.ReportExecutionService.ParameterValue>();
                    paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "From", Value = from.ToString("dd MMM yyyy") });
                    paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "OfficeID", Value = LoginUserOfficeID.Value.ToString() });
                    paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "to", Value = to.ToString("dd MMM yyyy") });
                    PrintSSRSReport("/gBanker_Reports/rpt_inv_DayXVoucher", paramValues.ToArray());
                    return Content(string.Empty);
        ...
        public ActionResult GetDisposeRequestReport(string disposeNo)
        {
            var paramValues = new List<gHRM.Service.ReportExecutionService.ParameterValue>();
            paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "OrgName", Value = (SessionHelper.OrganizationName).ToString() });
            paramValues.Add(new gHRM.Service.ReportExecutionService.ParameterValue() { Name = "DisposeRequestNo", Value = disposeNo });
            PrintSSRSReport("/gBanker_Reports/rpt_Inv_DisposeRequestReport", paramValues.ToArray());
            return Content(string.Empty);
        }
        #endregion Report
    }
