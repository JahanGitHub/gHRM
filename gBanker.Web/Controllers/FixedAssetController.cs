...
namespace gHRM.Web.Controllers
{
    ...
    public class FixedAssetController : BaseController
    {
        ...
        public FixedAssetController(IAssetGroupInfoService assetGroupInfoService,IAssetInfoService assetInfoService,
            ...
            IDepreciationMethodService depreciationMethodService, IClientTypeService clientTypeService, IProjectInfoService projectInfoService,
            ...
            IAssetUserService assetUserService, IEmployeeService employeeService, IAssetDepreciationInfoService assetDepreciationInfoService)
        {            
        ...
        private void OfficeWiseDropDownList()
        {
            ...
            ViewData["OfficeLevel"] = SessionHelper.LoginUserOfficeLevel;
        ...
        private void ToOfficeWiseDropDownList()
        {
            ...
            ViewData["OfficeLevelTo"] = SessionHelper.LoginUserOfficeLevel;
        ...
        public JsonResult RunYearEndProcess(int office_id)
        {
            ...
            try
            {
                ...
                var orgID = SessionHelper.CompanyID;
                var param = new { OfficeId = office_id, LastMonthEndDate=TransactionDate, OrgID = orgID, CreateUser = createUser };
                ultimateReportService.GetDataWithParameterFixedAsset(param, "fix.CalculateDepriciation");
        ...
        public JsonResult DeleteYearEndProcess(int office_id)
        {
            ...
            try
            {
                ...
                var orgID = SessionHelper.CompanyID;
                var param = new { OfficeId = office_id, LastMonthEndDate = TransactionDate, OrgID = orgID, CreateUser = createUser };
                ultimateReportService.GetDataWithParameterFixedAsset(param, "fix.DeleteCalculateDepriciation");
        ...
        public JsonResult SaveAssetGroupInformation(FixedAssetViewModel obj)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    model.AssetInAccCode = "";
                    model.AssetCurDepriDr = "";
                    model.AssetAccuDepriCr = "";                    
        ...
        public JsonResult LoadGroupCodeWiseGroupName(int GroupId)
        {
            ...
            var assetCode = ultimateReportService.GetDataWithParameterFixedAsset(param, "fix.SP_GetNextAssetCode");
        ...
        public JsonResult GetDailyTransactionInfo(int jtStartIndex, int jtPageSize, string jtSorting, int officeID, long assetID)
        {
            try
            {
                ...
                var dailyInfo = ultimateReportService.GetDataWithParameterFixedAsset(param, "fix.GetDailyTransactionInfo");
                var viewDailyInfo = dailyInfo.Tables[0].AsEnumerable().Select(p => new FixedAssetViewModel
                {
                    ...
                    TransactionDate = p.Field<DateTime>("TransactionDate").ToString("dd-MMM-yyyy",CultureInfo.InvariantCulture),
                    ...
                    DepCalcDate = p.Field<DateTime>("DepCalcDate").ToString("dd-MMM-yyyy", CultureInfo.InvariantCulture),
                    PurchaseDate = Convert.ToDateTime(p.Field<DateTime?>("PurchaseDate")).ToString("dd-MMM-yyyy", CultureInfo.InvariantCulture),
                    OperationDate = Convert.ToDateTime(p.Field<DateTime?>("OperationDate")).ToString("dd-MMM-yyyy", CultureInfo.InvariantCulture),
                    ...
                    InsExpDate = Convert.ToDateTime(p.Field<DateTime?>("InsuranceExpDate")).ToString("dd-MMM-yyyy", CultureInfo.InvariantCulture),
                    ...
                    PurOrderDate = Convert.ToDateTime(p.Field<DateTime?>("PurchaseOrderDate")).ToString("dd-MMM-yyyy", CultureInfo.InvariantCulture),
        ...
        public JsonResult UpdateDailyTransactionInfo(FixedAssetViewModel fixedAssetUpdates)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ultimateReportService.GetDataWithParameterFixedAsset(paramForUpdateDepriciationInfo, "fix.UpdateAssetDepreciationInfo");
        ...
        public JsonResult GetOfficeWiseAssetGroup(int officeID, string assetOutDate)
        {
            ...
            var officeWiseAssetGroup = ultimateReportService.GetDataWithParameterFixedAsset(param, "fix.SP_OfficeWiseAssetGroup");
        ...
        public JsonResult GetAssetGroupWiseAssetName(int office_id, int groupId, string assetOutDate)
        {
            ...
            var assetGroupWiseAssetName = ultimateReportService.GetDataWithParameterFixedAsset(param, "fix.SP_AssetGroupWiseAssetName");
        ...
        public JsonResult GetAssetWiseAssetSerial(int office_id, string assetOutDate, string assetCode)
        {
            ...
            var assetWiseAssetSerial = ultimateReportService.GetDataWithParameterFixedAsset(param, "fix.SP_AssetWiseAssetSerial");
        ...
        public JsonResult GetAssetSerialWiseAssetInfo(int office_id, string assetOutDate, string assetSerial)
        {
            ...
            var assetSerialWiseAssetInfo = ultimateReportService.GetDataWithParameterFixedAsset(param, "fix.SP_AssetSerialWiseAssetInfo");
        ...
        public JsonResult DeleteFixedAssetOut(long AssetOutID)
        {
            ...
            try
            {
                ...
                var getAssetOutInfo = ultimateReportService.GetDataWithParameterFixedAsset(param, "fix.GetAssetOutIdWiseDailyTranInfo");
        ...
        public JsonResult GetQuantityWiseAssetSerialForDailyEntry(int officeID, int assetID, int assetQuantity)
        {
            ...
            var assetSerialRange = ultimateReportService.GetDataWithParameterFixedAsset(param, "fix.GenerateAssetSerial");
        ...
        public JsonResult SaveAssetTransferInformation(FixedAssetViewModel transferInfo)
        {
            ...
            var message = "";
            var orgID = SessionHelper.CompanyID;
            int createUser = Convert.ToInt32(SessionHelper.LoggedInEmployeeID);
            int updateUser = Convert.ToInt32(SessionHelper.LoggedInEmployeeID);
            ...
            {                
                if (transferInfo.allTransactionId.Length > 0)
                {
                    foreach (var item in transferInfo.allTransactionId)
                    {
                        ...
                        var insertData = ultimateReportService.GetDataWithParameterFixedAsset(param, "fix.SaveAssetTransferInformation");
                    }                    
                };
                result = 1;
                message = "Saved successfully";
        ...
        public JsonResult GetAssetTransferInfo(int jtStartIndex, int jtPageSize, string jtSorting)
        {
            ...
            var officeList = officeService.GetMany(p => p.IsActive == true && p.CompanyId == orgID);
        ...
        //    model.officeListItems = viewOffice;3
        ...
        public JsonResult RunProcessFile()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var data = ultimateReportService.GetDataWithParameterFixedAsset(param, "fix.FixMonthClosingNew");
                    result = 1;
        ...
        public JsonResult CheckEntryDateValidation(int office_id)
        {
            ...
            var data = ultimateReportService.GetDataWithParameterFixedAsset(param, "fix.Get_FixedAsset_YearClosingDate");
        ...
        public ActionResult FixedAssetLedgerReportPrint()
        {
            try
            {
                ...
                var data = ultimateReportService.GetDataWithParameterFixedAsset(param, "fix.SP_RPT_FixedAssetLedger");
        ...
        public ActionResult AssetCodeWiseFixedAssetScheduleReportPrint(int Year)
        {
            try
            {
                ...
                var data = ultimateReportService.GetDataWithParameterFixedAsset(param, "fix.SP_RPT_FixedAssetScheduleSummeryYearWise");
                var reportParam = new Dictionary<string, object>();
        ...
        public ActionResult FixAssetDepriciationRegisterReportPrint(int Year, int Month)
        {
            try
            {
                ...
                var data = ultimateReportService.GetDataWithParameterFixedAsset(param, "fix.SP_RPT_FixAssetDepriciationRegister");
                var reportParam = new Dictionary<string, object>();
        ...
        public ActionResult PrintDailyTransactionReport()
        {
            try
            {
                var data = ultimateReportService.GetDataWithoutParameterFixedAsset("fix.SP_RPT_GetDailyTransaction");
                var reportParam = new Dictionary<string, object>();
        ...
        public ActionResult TopSheetFixedAssetScheduleReportPrint(int IsForAllBranch, DateTime Date)
        {
            try
            {
                if (IsForAllBranch == 1)
                {
                    ...
                    var data = ultimateReportService.GetDataWithParameterFixedAsset(param, "fix.SP_RPT_GetAssetTopSheet");
                    var reportParam = new Dictionary<string, object>();
        ...
        {
            var loginUserRoleId =  SessionHelper.LoggedInRoleId;           
            gHRMDBContext context = new gHRMDBContext();
        ...
        public ActionResult GroupWiseAssetList()
        {
            ...
            var offcdetail = officeService.GetById(Convert.ToInt32(SessionHelper.LoginUserOfficeID));
            ViewData["OfficeLevel"] = SessionHelper.LoginUserOfficeLevel;
            //ViewData["OfficeLevel"] = Session[SessionKeys.LOGGED_IN_OFFICE_DETAIL];
            if (offcdetail.OfficeLevel == 1)
            {
                ViewData["FirstLevel"] = officeService.GetByOfficeCode(offcdetail.FirstLevel).OfficeId;
                ViewData["SecondLevel"] = officeService.GetByOfficeCode(offcdetail.FirstLevel).OfficeId;
        ...
        public ActionResult GenerateGroupWiseAssetListReport(int office_id, string to_date, int qType, int AllOffice, int groupFrom)
        {
            ...
            try
            {
                ...
                PrintSSRSReport("/gHRMPlus_Reports/FIX_Group_Wise_Asset_List", paramValues.ToArray());
                return Content(string.Empty);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult GenerateCompanyWiseAssetStatementReport(int office_id, string to_date, int qType, int AllOffice)
        {
            try
            {
                ...
                PrintSSRSReport("/gHRMPlus_Reports/FIX_Compnay_Wise_Asset_Statement", paramValues.ToArray());
                return Content(string.Empty);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult GenerateUserWiseAssetListReport(int office_id, string to_date, int qType, int AllOffice, int groupFrom)
        {
            ...
            try
            {
                ...
                PrintSSRSReport("/gHRMPlus_Reports/FIX_User_Wise_Asset_list", paramValues.ToArray());
                return Content(string.Empty);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult GenerateLocationWiseAssetListReport(int office_id, string to_date, int qType, int AllOffice, int groupFrom)
        {
            ...
            try
            {
                ...
                PrintSSRSReport("/gHRMPlus_Reports/FIX_Location_Wise_Asset_list", paramValues.ToArray());
                return Content(string.Empty);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult ListOfAssetAdditions()
        {
            ...
            ViewData["TrxDateFrom"] = DateTime.Now.ToString("dd-MMM-yyyy", CultureInfo.InvariantCulture);
            ViewData["TrxDateTo"] = DateTime.Now.ToString("dd-MMM-yyyy", CultureInfo.InvariantCulture);
            MapDropdownForGroupWiseAssetList();
            return View();
        }
        //TODO: rdlc
        public ActionResult GenerateListOfAssetAdditionstReport(int office_id, string from_date, string to_date, int qType, int AllOffice, int groupFrom)
        {
            ...
            try
            {
                ...
                PrintSSRSReport("/gHRMPlus_Reports/FIX_List_Of_Asset_Additions", paramValues.ToArray());
                return Content(string.Empty);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult GenerateListOfAssetSalesReport(int office_id, string from_date, string to_date, int qType, int AllOffice, int groupFrom)
        {
            ...
            try
            {
                ...
                PrintSSRSReport("/gHRMPlus_Reports/FIX_List_Of_Asset_Sales", paramValues.ToArray());
                return Content(string.Empty);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult FixedAssetsDepreciationSchedule()
        {
            ...
            ViewData["TrxDate"] = DateTime.Now.ToString("dd-MMM-yyyy", CultureInfo.InvariantCulture);
            MapDropdownForGroupWiseAssetList();
            return View();
        }
        //TODO: rdlc
        public ActionResult GenerateAssetDepriciationScheduletReport(int office_id, string to_date, int qType, int AllOffice)
        {
            try
            {
                ...
                PrintSSRSReport("/gHRMPlus_Reports/FIX_Fixed_Assets_And_Depreciation_Schedule", paramValues.ToArray());
                return Content(string.Empty);
            }
            catch (Exception ex)
            {
