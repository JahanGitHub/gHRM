...
namespace gHRM.Web.Controllers
{
    public class ExcelImportController : BaseController
    {
        ...
        public ActionResult Challan() { Name = CHALLAN; return ImportPage(); }

        public ActionResult Salary() { Name = SALARY; return ImportPage(); }
        ...
        public ActionResult Import(string Name, FormCollection formCollection)
        {
            ...
            else if (CHALLAN == Name) ExcelImport = new ChallanBLExcelImport();
            else if (SALARY == Name) ExcelImport = new SalaryBLExcelImport();
            else
            {
            ...
            try
            {
                ...
                {
                    ExcelImport.ProcessData(package.Workbook.Worksheets, this);
                }
            }
        ...
        private void SetSaveBtnCaption()
        {
            ...
            switch (Name)
            {
                ...
                case PROMOTION_BACKLOG:
                    ...
                    break;
                case CHALLAN:
                    SaveBtnCaption = "Click Herer to Import your Challan from excel";
                    break;
                default:
                    break;
            }
        ...
        private void SetSampleFilePath()
        {
            ...
            switch (Name)
            {
                ...
                case PROMOTION_BACKLOG:
                    ...
                    break;
                case CHALLAN:
                    SampleFilePath = "challan/challan-import-sample-file.xlsx";
                    break;
                default:
                    break;
            }
