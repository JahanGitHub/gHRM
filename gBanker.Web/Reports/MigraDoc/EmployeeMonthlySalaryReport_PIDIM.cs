...
{
    public class EmployeeMonthlySalaryReport_PIDIM
    {
        ...
        public EmployeeMonthlySalaryReport_PIDIM(HttpContextBase Context)
        {
        ...
        private void PageSetup(Document Doc, Section Sec)
        {
            ...
            Sec.PageSetup.LeftMargin = new Unit(0.8, UnitType.Inch);
        ...
        private void AddHeader(Section Sec)
        {
            ...
            Tbl.Format.Font.Size = 7.5;// Settings.BodyFontSize;
            Tbl.LeftPadding = 0.3;
            Tbl.RightPadding = 0.3;
            AddTableHeader(Tbl);
        }
        ...
        private void AddTableCols(Table Tbl)
        {
            ...
            for (int i = 0; i < TblTotalColCount; i++)
            {
                ...
                if (0 == i)
                    ColWidth = totallenght-.01;
                //if (1 == i)
                //    ColWidth = totallenght - .1;
                if (2 == i)
                    ColWidth = totallenght*2.9;
                else if(3 == i)
                    ColWidth = totallenght * 3;
